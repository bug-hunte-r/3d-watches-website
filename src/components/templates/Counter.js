        ...
        <div className='container'>
            <div className='container-counter'>
                <div className='container-text-and-number-counter'>
                    <CountUp from={0} to={252} separator="," direction="up" duration={1} className="number-counter" />
                    <h1 className='title-counter'>happy customers</h1>
                </div>
                <div className='container-text-and-number-counter'>
                    <CountUp from={0} to={10} separator="," direction="up" duration={1} className="number-counter" />
                    <h1 className='title-counter'>years experiance</h1>
                </div>
                <div className='container-text-and-number-counter'>
                    <CountUp from={0} to={67} separator="," direction="up" duration={1} className="number-counter" />
